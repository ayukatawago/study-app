      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-8">
        ...
        <div className="border border-gray-200 dark:border-gray-700 rounded-xl p-6">
          ...
          <div className="space-y-4">
            <div>
              <h3 className="text-lg font-semibold text-gray-400 dark:text-gray-500 mb-3">地学</h3>
              <div className="text-gray-500 dark:text-gray-400 italic text-sm">近日追加予定</div>
            </div>
            <div>
              <h3 className="text-lg font-semibold text-gray-400 dark:text-gray-500 mb-3">物理</h3>
              <div className="text-gray-500 dark:text-gray-400 italic text-sm">近日追加予定</div>
            </div>
            <div>
              <h3 className="text-lg font-semibold text-gray-400 dark:text-gray-500 mb-3">化学</h3>
              <div className="text-gray-500 dark:text-gray-400 italic text-sm">近日追加予定</div>
            </div>
          </div>
        </div>
